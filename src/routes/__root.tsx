...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "findable | Agentic AI for finding talent" },
      { name: "description", content: "Build recruiting projects in seconds with findable. Use agentic AI to create JDs, source candidates, post jobs, schedule interviews, and hire faster." },
      { name: "author", content: "findable" },
      { property: "og:title", content: "findable | Agentic AI for finding talent" },
      { property: "og:description", content: "Build recruiting projects in seconds with findable. Use agentic AI to create JDs, source candidates, post jobs, schedule interviews, and hire faster." },
